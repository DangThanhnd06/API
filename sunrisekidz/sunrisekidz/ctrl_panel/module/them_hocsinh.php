<script type="text/javascript">
	function checkform() {
        ...
        if(document.frm.video.value=="") {
			alert("Bạn chưa chọn hình bé ! Vui lòng chọn.");
			document.frm.video.focus();
			return false;
		}
        if($('#hotencha').val()==''){
...
<div class="lienhe">
	...
	<form action="" method="post" enctype="multipart/form-data" name="frm" onsubmit="return checkform();">
        ...
        <div>
			...
			<input type="file" name="video" /> (Kích thước ảnh lớn hơn hoặc bằng 127px x 124px)
