...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="")
{
      ...
      $smtp_host ='mail.nguyenquoc.com.vn';//Dia chi mail server
      $admin_email = 'info@nguyenquoc.com.vn';//User duoc khai bao tren mail server
      $smtp_username = 'info@nguyenquoc.com.vn';//User duoc khai bao tren mail server
      $smtp_password = 'Nguyenquoc@123';//Pass cua email nay
...
//Test send mail
/*if(SendMail("quochoai.2202@gmail.com","info@nguyenquoc.com.vn","Details of Booking Form","Content Testing"))
    echo 'thanh cong';
else
    echo 'that bai';
*/
