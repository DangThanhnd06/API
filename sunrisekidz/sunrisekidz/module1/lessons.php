<div id="content">
                <div class="ageg">
                    <h3 class="ag"><?=_agegroup?></h3>
                    <div class="ctag">
                        <ul>
                            <li class="f act"><a class="agea" rel="1">18 - 24 <?=_month?></a></li>
                            <li><a class="agea" rel="2">24 - 36 <?=_month?></a></li>
                            <li><a class="agea" rel="3">3 - 4 <?=_yearold?></a></li>
                            <li><a class="agea" rel="4">4 - 5 <?=_yearold?></a></li>
                            <li class="l"><a class="agea" rel="5">5 - 6 <?=_yearold?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="rightage">
                    ...
                    <div class="title">
                        ...
                        <p class="thang"><a class="cmon"><span class="mthn"><?=$_SESSION['thanght']?></span></a></p>
                    ...
                    <?php
                        $sp = $h->query("select id,name_vn,name_en from practise where age=1 and hide=1 order by sort asc,id asc");
                        $ip = 0;
                    ...
                    ?>
                        <div class="cten<?=$eo.$clp?>" id="cten<?=$idp?>"><a class="cp" rel="<?=$idp?>"><?=$np?></a></div>
                    <?php $ip++; } ?>
                    </div>
                    <div class="lesss">
                    <?php
                        $spp = $h->query("select id,name_vn,name_en from practise where age=1 and hide=1 order by sort asc,id asc");
                    ...
                    <?php
                        ...
                        if($idpp!=0 && $idll!=0){
                        $sd = $h->query("select id,detail_vn,detail_en,week,day from lessons where lesson_id=$idll and year=$yr and month=".$mn." order by id asc");
                        $id = 0;
                    ...
                    ?>
                        <p class="cten<?=$cld.$cla?>"><a class="dell" rel="<?=$idd?>"><?=$dell?></a><a class="editde" rel="<?=$idd?>">&nbsp;</a><a class="delde" rel="<?=$idd?>">&nbsp;</a></p>
                    <?php $id++; } ?>
                    ...
                    <div class="thangg">
                        ...
                        ?>
                            <p class="ctenn<?=$clw.$cls?>"><?=_lessweek.' '.$vw?></p>
                        <?php } ?>
                        </div>
                    </div>
                    <div class="ngayy">
                ...
                <div id="popup12" class="ghpopup">
                    ...
                    <div class="form scrollbar-macosx">
                        <form>
                            ...
                            <div>
                                <label for="mnumber"><?=_lesspractice?></label>
                                <div class="select-style">
                                    <select id="prr_id" name="prr_id">
                                    <?php
                                        $sh = $h->query("select id,name_vn,name_en from practise where age=1 and hide=1 ORDER BY sort asc, id asc");
                                        while($rh = $h->fetch_array($sh)){
                                            echo '<option value="'.$rh['id'].'">'.$rh["name_$lang"].'</option>';
                                        }
                                    ?>
                                    </select>
                                </div>
