<div id="content">
                <div class="ageg">
                    ...
                    <div class="ctag">
                        <ul>
                            <li class="f act"><a class="agea" rel="Blude Cylinder">Blude Cylinder</a></li>
                            <li><a class="agea" rel="Red rod">Red rod</a></li>
                            <li><a class="agea" rel="Trinomial 1">Trinomial 1</a></li>
                            <li><a class="agea" rel="Trinomial 2">Trinomial 2</a></li>
                            <li><a class="agea" rel="SOC">SOC</a></li>
                            <li><a class="agea" rel="TAM">TAM</a></li>
                            <li><a class="agea" rel="Cranberry">Cranberry</a></li>
                            <li class="l"><a class="agea" rel="Juneberry">Juneberry</a></li>
                        </ul>
                    </div>
                </div>
                <div class="rightage">
                    ...
                    <?php
                        $sp = $h->query("select id,name_vn,name_en from practise where clg='Blude Cylinder' and hide=1 order by sort asc,id asc");
                        $ip = 0;
                    ...
                    <div class="lesss">
                    <?php
                        $spp = $h->query("select id,name_vn,name_en from practise where clg='Blude Cylinder' and hide=1 order by sort asc,id asc");
                    ...
                    <?php
                        ...
                        if($idpp!=0 && $idll!=0){
                        $sd = $h->query("select id,detail_vn,detail_en,week,day from lessons where lesson_id=$idll and year=$yr and month=".$mn." order by week asc,day asc,id asc");
                        $id = 0;
