<?php
    ...
    $yr = date("Y");
    $month = $_POST['thang'];
    $_SESSION['mnnn'] = $_POST['thang'];
    $mdd = "";
    $mn = "";
    $mtb = "";
    if($class_id != "" && $practice != 0 && $lesson != 0){
            ...
            if($child_id != 0) {
                ...
                if($nd){
                    ...
                    if($mkk == 0.5){
                        ...
                        $mdd .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                        $mdd .= '</div>';
                    }
                    if($mkk == 1.0){
                        $mdd .= '<div class="dd" style="padding-left:40%;">';
                        $mdd .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                        $mdd .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                        $mdd .= '</div>';
                    }
                    if($mkk == 1.5){
                        ...
                        $mdd .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                        $mdd .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                        $mdd .= '   <p class="op5 red"><img src="img/star_red1.png" /></p>';
                        $mdd .= '</div>';
                    }
                    if($mkk == 2.0){
                        $mdd .= '<div class="dd" style="padding-left:30%;">';
                        ...
                        $mdd .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                        $mdd .= '   <p class="op5 red"><img src="img/star_red1.png" /></p>';
                        $mdd .= '   <p class="two red"><img src="img/star_red2.png" /></p>';
                        $mdd .= '</div>';
                    }
                    if($mkk == 2.5){
                        $mdd .= '<div class="dd">';
                        $mdd .= '   <p class="ohp5 green"><img src="img/star_green1.png" /></p>';
                        $mdd .= '   <p class="one green"><img src="img/star_green2.png" /></p>';
                        $mdd .= '   <p class="op5 green"><img src="img/star_green1.png" /></p>';
                        $mdd .= '   <p class="two green"><img src="img/star_green2.png" /></p>';
                        $mdd .= '   <p class="tp5 green"><img src="img/star_green1.png" /></p>';
                        $mdd .= '</div>';
                    }
                    if($mkk == 3.0){
                        $mdd .= '<div class="dd">';
                        ...
                        $mdd .= '   <p class="two green"><img src="img/star_green2.png" /></p>';
                        $mdd .= '   <p class="tp5 green"><img src="img/star_green1.png" /></p>';
                        $mdd .= '   <p class="three green"><img src="img/star_green2.png" /></p>';
                        $mdd .= '</div>';
                    }
                } else {
        ...
        if($sl != 0){
            ...
            if($dtbb > 0 && $dtbb < 1) {
                ...
                $mtb .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                $mtb .= '</div>';
            } elseif($dtbb >= 1 && $dtbb < 1.5){
                $mtb .= '<div class="dd" style="padding-left:40%;">';
                $mtb .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                $mtb .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                $mtb .= '</div>';
            } elseif($dtbb >= 1.5 && $dtbb < 2){
                $mtb .= '<div class="dd" style="padding-left:30%;">';
                $mtb .= '   <p class="ohp5 red"><img src="img/star_red1.png" /></p>';
                $mtb .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                $mtb .= '   <p class="op5 red"><img src="img/star_red1.png" /></p>';
                $mtb .= '</div>';
                ...
                $mtb .= '   <p class="one red"><img src="img/star_red2.png" /></p>';
                $mtb .= '   <p class="op5 red"><img src="img/star_red1.png" /></p>';
                $mtb .= '   <p class="two red"><img src="img/star_red2.png" /></p>';
                $mtb .= '</div>';
            } elseif($dtbb >= 2.5 && $dtbb < 3){
                $mtb .= '<div class="dd">';
                $mtb .= '   <p class="ohp5 green"><img src="img/star_green1.png" /></p>';
                $mtb .= '   <p class="one green"><img src="img/star_green2.png" /></p>';
                $mtb .= '   <p class="op5 green"><img src="img/star_green1.png" /></p>';
                $mtb .= '   <p class="two green"><img src="img/star_green2.png" /></p>';
                $mtb .= '   <p class="tp5 green"><img src="img/star_green1.png" /></p>';
                $mtb .= '</div>';
            } else {
                $mtb .= '<div class="dd">';
                $mtb .= '   <p class="ohp5 green"><img src="img/star_green1.png" /></p>';
                ...
                $mtb .= '   <p class="two green"><img src="img/star_green2.png" /></p>';
                $mtb .= '   <p class="tp5 green"><img src="img/star_green1.png" /></p>';
                $mtb .= '   <p class="three green"><img src="img/star_green2.png" /></p>';
                $mtb .= '</div>';
            }
        } else $mtb = "";
    } 
