<div id="content">
                <div class="searchsl">
                    ...
                    <div class="ctsearch">
                        ...
                        <input class="butt" type="button" id="loginsys" value="<?=_login?>" />
                    </div>
                    <div class="download">
                ...
                <div class="rightsl">
                    ...
                    <div class="cten scrollbar-macosx">
                    <?php
                        ...
                        while($rl = $h->fetch_array($sl)){
                            ...
                            if(!in_array($rl['actiondetail'],$rrr)) {
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $('#loginsys').live('click', function(){
           $.post("module/search_loglogin.php", function(data){
                $('.cten').fadeIn('slow').html(data);
           }); 
        });
    })
