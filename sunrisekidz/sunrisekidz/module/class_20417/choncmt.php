<?php
    ...
    $_SESSION['chonmarkcomment'] = 'commenttt';
?>
<div class="searchcl">
                    <div  class="search">
                        <?=_search?>
                    ...
                    <div class="markcomment">
                        <div class="week">
                            <?php 
                                ...
                                foreach($mthang as $ka=>$va){
                                    if($ka == $_SESSION['mnnnn'])
                                        $mssw .= '<a class="chonthag act" rel="'.$ka.'">'.$va.'</a>';
                                    else
                                        $mssw .= '<a class="chonthag" rel="'.$ka.'">'.$va.'</a>';
                                }
                                echo $mssw;
                            ?>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('select#sc').live("change",function(){
                ...
                if(practise == 0){
                    ...
                    //$('.namc').html('<?=date("Y")?>');
                    /*var wwe = '<a class="choosemonth" rel="1"><?=_thang1?></a>';
                        wwe += '<a class="choosemonth" rel="2"><?=_thang2?></a>';
                        wwe += '<a class="choosemonth" rel="3"><?=_thang3?></a>';
                        wwe += '<a class="choosemonth" rel="4"><?=_thang4?></a>';
                        wwe += '<a class="choosemonth" rel="5"><?=_thang5?></a>';
                        wwe += '<a class="choosemonth" rel="6"><?=_thang6?></a>';
                        wwe += '<a class="choosemonth" rel="7"><?=_thang7?></a>';
                        wwe += '<a class="choosemonth" rel="8"><?=_thang8?></a>';
                        wwe += '<a class="choosemonth" rel="9"><?=_thang9?></a>';
                        wwe += '<a class="choosemonth" rel="10"><?=_thang10?></a>';
                        wwe += '<a class="choosemonth" rel="11"><?=_thang11?></a>';
                        wwe += '<a class="choosemonth" rel="12"><?=_thang12?></a>';
                    $('.week').html(wwe);
                    */
                }
        ...
        $('select#cl').live("change",function(){
                ...
                if(sci==0) {
                    ...
                    if(cl != "") {
                        ...
                        $.post("module/class/show_binhluan.php",{
                            sci: sci,
                            cl: cl,
                            child_id: child_id,
                            practise: practise
        ...
        $('.hss').live("click",function(){
           ...
           if($('.monhocc').hasClass('act'))
            ...
            var practise = 0;
            //alert(child_id+' / '+sci+' / '+cl+' / '+practise);
           if(practise == 0) var sbll = "show_binhluan.php";
                else var sbll = "show_binhluanthang.php";
           $.post("module/class/show_binhluan.php",{
            sci: sci,
