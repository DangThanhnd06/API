<?php
    ...
    $data['mname'] = str_replace("'","\'",trim($_POST['mname']));
    $data['fullname'] = str_replace("'","\'",trim($_POST['fname'])).' '.str_replace("'","\'",trim($_POST['mname']));
    if($_SESSION['quyenper'] == 2) $data['school_id'] = $_SESSION['schd'];
