...
?>
                                ...
                                <?php
                                    ...
                                    while($rasc = $h->fetch_array($sasc)){
                                        if($lang == 'vn')
                                            ...
                                            $ttcc = change($rasc['tieude']);
                                        if($rasc['id'] == $r['school_id'])
                                            echo '<option value="'.$rasc['id'].'" selected>'._school.' '.$ttcc.'</option>';
                                        else
                                            echo '<option value="'.$rasc['id'].'">'._school.' '.$ttcc.'</option>';
                                    }
                                ?>
                    ...
                    <div>
                        <label for="teacherid"><?=_namvaotruong?></label>
                        <input type="text" name="namvaotruonge" id="namvaotruonge" class="in" value="<?=$r['namvaotruong']?>" />
                    </div>
                    <div>
