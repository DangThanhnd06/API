...
function(t) {
	var e = {},
		s = {
			...
			slideSelector: "",
			infiniteLoop: !0, //If true, clicking "Next" while on the last slide will transition to the first slide and vice-versa
			hideControlOnEnd: !1, //If true, "Next" control will be hidden on last slide and vice-versa
			speed: 500, //Slide transition duration (in ms)
			easing: null, // if using CSS: 'linear', 'ease', 'ease-in', 'ease-out', 'ease-in-out', 'cubic-bezier(n,n,n,n)'. If not using CSS: 'swing', 'linear' (see the above file for more options)
			...
			var a = t(window).width(),
				...
				w = function() {
					for (var e = "", i = x(), s = 0; i > s; s++) {
						...
						e += '<div class="bx-pager-item item' + s + '"><a href="" data-slide-index="' + s + '" class="bx-pager-link">' + n + "</a></div>"
					}
					o.pagerEl.html(e)
				},
				T = function() {
